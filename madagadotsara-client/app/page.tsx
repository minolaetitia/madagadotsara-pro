...
export default function Home() {
  ...
  const featuredAudio = [
    { id: 1, title: 'Midnight Vibes', creator: 'Ramy Beats', price: 50000, genre: 'Hip-Hop', bpm: 95, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3' },
    { id: 2, title: 'Ocean Breeze', creator: 'Lova Studio', price: 40000, genre: 'Lo-Fi', bpm: 80, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3' },
    { id: 3, title: 'Electric Dreams', creator: 'Dizo Sounds', price: 60000, genre: 'Electronic', bpm: 128, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3' },
    { id: 4, title: 'Tropical Paradise', creator: 'Tsilaon Audio', price: 45000, genre: 'Tropical House', bpm: 110, audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3' },
  ];
